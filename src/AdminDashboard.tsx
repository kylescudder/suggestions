    ...
    <div className="max-w-6xl mx-auto">
      ...
      <div className="mb-6">
        <p className="text-purple-200 text-center">
          {selectedStatus
            ? `Showing ${selectedStatus} suggestions`
      ...
      {suggestions.length === 0 ? (
        <div className="text-center py-12">
          ...
          <p className="text-purple-200">
            Encourage your community to share their sparks.
          </p>
        </div>
      ) : (
        <div className="space-y-4">
          {suggestions.map((suggestion) => (
            <div
              key={suggestion._id}
              className="bg-white/10 backdrop-blur-md rounded-xl p-6 border border-white/20 magical-glow"
            >
              <div className="flex justify-between items-start mb-4">
                <div className="flex-1">
                  ...
                  <div className="flex items-center gap-3 mb-3">
                    <span
                      className={`px-3 py-1 rounded-full text-sm font-medium border flex items-center gap-1 ${getStatusColor(suggestion.status)}`}
                    >
                ...
                <div className="ml-4">
                  ...
                  >
                    ...
                    <option value="implemented" className="bg-gray-800">
                      Implemented
                    </option>
